                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="signupform" class="form-horizontal" role="form" method="POST" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label for="apellidos" class="col-md-3 control-label">Como colocar la tabla compra aqui con su id?:</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label for="usuario" class="col-md-3 control-label">Total:</label>
                                        <div class="col-md-9">
                                            <input type="number" step="0.01" min="0" class="form-control" name="total" placeholder="Costo por Libra" value="<?php if (isset($direccion)) echo $direccion; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="apellidos" class="col-md-3 control-label">Como colocar el insumo aqui con su id?:</label>
                                        <div class="col-md-9">

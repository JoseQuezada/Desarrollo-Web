                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="email" placeholder="Ingrese su usuario" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">Contrseña</label>
                                                <input class="form-control py-4" id="inputPassword" type="password" placeholder="Ingrese su contraesña" />
                                            </div>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="register.html">Registrar Usuario</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

                            ...
                            <div class="panel-body">
                                ...
                                <form id="signupform" class="form-horizontal" role="form" method="POST" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label for="nombre" class="col-md-3 control-label">ID:</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="ID" placeholder=" " value="<?php if (isset($nombre)) echo $nombre; ?>" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="nombre" class="col-md-3 control-label">Usuario:</label> <!--Este campo debe quedar ineditable-->
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="usuario" placeholder="Usuario" value="<?php if (isset($nombre)) echo $nombre; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="nombre" placeholder="Nombre" value="<?php if (isset($apellidos)) echo $apellidos; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="username" type="text" class="form-control" name="usuario" placeholder="Apellidos" value="<?php if (isset($usuario)) echo $usuario; ?>" required>
                                        </div>
                                    </div>
